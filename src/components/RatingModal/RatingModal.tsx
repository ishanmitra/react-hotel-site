        ...
        >
            <div className="bg-white w-96 p-4 rounded-lg shadow-lg">
                    ...
                    <div className="flex items-center">
                        {starValues.map(value => (
                            <button className={`w-6 h-6 ${
                                    ratingValue != null ?
                                        (ratingValue >= value ? "text-yellow-500" : "text-gray-300") : "text-gray-300"
                                }`}
                ...
                <div className="flex justify-end">
                    ...
                    <button onClick={toggleRatingModal} className="ml-2 px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-g">
                        Cancel
                    </button>
                </div>
            </div>
